# -------------------------------------------------------------------------
# Application 2: nonviable implant data
# -------------------------------------------------------------------------
#
# Response:
#   Number of nonviable implants among 13 implants.
#
# Models:
#   B   = Binomial
#   BB  = Beta-binomial
...
p_prob <- ggplot() +
  ...
  labs(
    x = "Number of nonviable implants",
    y = paste0(
...
# -------------------------------------------------------------------------
# Threshold-conditioned probability checks
# -------------------------------------------------------------------------
...
p_hazard <- ggplot(
  ...
  labs(
    x = "Number of nonviable implants",
    y = paste0(
      "Probability of exactly x nonviable implants\n",
      "given at least x nonviable implants"
    ),
    colour = NULL,
    linetype = NULL,
    shape = NULL
...
p_mrc <- ggplot(
  ...
  labs(
    x = "Number of nonviable implants",
    y = paste0(
      "Expected additional nonviable implants\n",
      "given at least x nonviable implants"
    ),
    colour = NULL,
    linetype = NULL,
